...
<acme:form> 
	<acme:input-moment readonly = "true" code="authenticated.bulletin.form.label.instantiationMoment" path="instantiationMoment"/>
	...
	<acme:input-checkbox code="authenticated.bulletin.form.label.flag" path="flag"/>
